    ...
    <div className="container mx-auto px-4 py-8 space-y-8">
      ...
      <section className="space-y-4">
        ...
        <p className="text-lg text-muted-foreground">
          당사는 개인정보 보호를 매우 중요하게 생각합니다. 이 정책은 귀하의 정보가 어떻게 수집, 사용 및 보호되는지 설명합니다.
        </p>
      </section>
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>수집된 정보는 다음의 목적으로 사용됩니다</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-sm">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm">
              당사는 귀하의 개인정보를 보호하기 위해 업계 표준의 보안 조치를 취합니다.
              여기에는 암호화, 보안 서버, 그리고 접근 제어가 포함됩니다.
              다만, 인터넷 전송의 완전한 보안을 보장할 수 없음을 이해하시기 바랍니다.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm">
              당사는 법률이 요구하지 않는 한 필요한 기간 동안만 개인정보를 보관합니다.
              서비스 목적이 달성되거나 사용자가 요청하면 개인정보는 삭제 또는 익명화됩니다.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm">
              개인정보 보호 정책에 대한 질문이 있으시거나 개인정보 요청이 있으신 경우,
              언제든지 당사에 문의해 주시기 바랍니다.
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="rounded-lg border border-muted bg-muted/50 p-4">
        <p className="text-sm text-muted-foreground">
          마지막 업데이트: 2026년 4월. 당사는 이 정책을 수시로 업데이트할 수 있습니다.
          변경사항은 이 페이지에 게시되며, 귀하는 정기적으로 확인할 것을 권장합니다.
        </p>
      </div>
    </div>
  );
