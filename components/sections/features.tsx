...
const features = [
  {
    ...
    title: "노션 CMS 연동",
    description:
      "노션 데이터베이스에서 견적서를 작성하면 웹에서 자동으로 렌더링됩니다. 별도의 코딩 없이 노션만으로 견적서를 관리하세요.",
    icon: DatabaseIcon,
  },
  {
    id: 2,
    title: "고유 링크 공유",
    description:
      "UUID 기반의 고유 링크를 생성하여 클라이언트에게 전달하세요. 로그인 없이도 견적서를 확인할 수 있습니다.",
    icon: LinkIcon,
  },
  {
    id: 3,
    title: "PDF 다운로드",
    description:
      "견적서를 PDF 파일로 다운로드할 수 있습니다. 한글 폰트를 지원하며 인쇄에 최적화된 레이아웃을 제공합니다.",
    icon: FileDownIcon,
  },
];
