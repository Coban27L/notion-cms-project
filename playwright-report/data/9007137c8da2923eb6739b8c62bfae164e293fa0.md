...
- Name: pdf-download.spec.ts >> PDF 다운로드 기능 >> PDF 다운로드 버튼이 표시되고 클릭 가능해야 함
- Location: __tests__/e2e/pdf-download.spec.ts:8:7
...
Locator: getByRole('button', { name: /PDF 다운로드/ })
Expected: visible
Timeout: 5000ms
