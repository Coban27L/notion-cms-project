...
- Name: pdf-download.spec.ts >> 공유 링크에서 견적서 조회 >> 공유 링크 복사 버튼이 작동해야 함
- Location: __tests__/e2e/pdf-download.spec.ts:80:7
...
Locator: getByRole('button', { name: /링크 복사/ })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /링크 복사/ })
